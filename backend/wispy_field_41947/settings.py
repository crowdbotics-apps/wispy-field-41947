"""
Django settings for wispy_field_41947 project.
...
ROOT_URLCONF = 'wispy_field_41947.urls'
...
WSGI_APPLICATION = 'wispy_field_41947.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wispy_field_41947 API",
    "DESCRIPTION": "API documentation for wispy_field_41947 App",
    "VERSION": "v1",
}
